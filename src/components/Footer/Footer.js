        ...
        <div className="containerFooter">
          <div className="icons">
            ...
            <a className="social-link" href="https://twitter.com/NetflixBrasil" target="_blank" aria-label="twitter">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="svg-icon svg-icon-twitter-logo">
          ...
          <div className="about">
            <span>© 1997-2022 Netflix, Inc. ~ 6ce90f7a-aa87-4ea5-89de-fb84ce90286r</span>
          </div>
        </div>
      </footer>
    )
